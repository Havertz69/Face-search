...
const UploadSection = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (!faceData.faces || faceData.faces.length === 0) {
        throw new Error(
          "No faces detected in the image. Please upload a clear photo with a visible face.",
        );
      }
      ...
      const reverseSearchResults =
        await performReverseImageSearch(selectedImage);
  ...
  const analyzeFace = async (imageUrl) => {
    ...
    try {
      const response = await fetch(
        `${API_ENDPOINTS.googleVision}?key=${process.env.REACT_APP_GOOGLE_VISION_API_KEY}`,
        {
          method: "POST",
          headers: {
        ...
        resolve([
          {
            ...
            image: {
              thumbnailLink: "https://graph.facebook.com/johndoe/picture",
            },
          ...
          },
          {
            ...
            image: {
              thumbnailLink: "https://instagram.com/johndoe_photo/profile.jpg",
            },
  ...
  const searchSocialMedia = async (faceData, reverseSearchResults) => {
    ...
    const [fbResults, igResults, twResults, liResults, ytResults, ttResults] =
  ...
  const extractNamesFromResults = (results) => {
    ...
    results.forEach((result) => {
      ...
      namePatterns.forEach((pattern) => {
        const matches = [
          ...title.matchAll(pattern),
          ...snippet.matchAll(pattern),
        ];
    ...
    for (const name of names) {
      try {
        ...
        results.push({
          ...
          location: ["New York, NY", "Los Angeles, CA", "San Francisco, CA"][
    ...
    for (const name of names) {
      try {
        ...
        results.push({
          ...
          company: ["Tech Corp", "Global Inc", "Startup Co", "Enterprise Ltd"][
            Math.floor(Math.random() * 4)
          ],
          location: [
            "San Francisco, CA",
  ...
  const analyzeProfiles = async (socialResults) => {
    ...
    Object.keys(enhancedResults).forEach((platform) => {
      enhancedResults[platform] = enhancedResults[platform].filter(
  ...
  return (
    <div className="upload-section">
      <div className="upload-card">
        ...
        <p>
          Upload a clear photo to search for matching profiles across social
          platforms
        </p>
        ...
        <div className="upload-box" onClick={triggerFileInput}>
          ...
          <p>
            Drag and drop or <span className="browse-link">browse</span> to
            upload
          </p>
          <input
            type="file"
            ...
            <div className="platforms-grid">
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <span className="result-count">
                    {searchResults.facebook.length} matches
                  </span>
                </div>
              ...
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <h4>Instagram</h4>
                  <span className="result-count">
                    {searchResults.instagram.length} matches
                  </span>
                </div>
                <div className="results-list">
              ...
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <h4>Twitter</h4>
                  <span className="result-count">
                    {searchResults.twitter.length} matches
                  </span>
                </div>
                <div className="results-list">
              ...
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <h4>LinkedIn</h4>
                  <span className="result-count">
                    {searchResults.linkedin.length} matches
                  </span>
                </div>
                <div className="results-list">
                  {searchResults.linkedin.map((result, index) => (
                    <div key={index} className="result-item">
                      ...
                      <span className="result-meta">
                        {result.company} • {result.connections} connections
                      </span>
                      <span className="result-meta">{result.location}</span>
                      <a
                        href={result.profile}
              ...
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <h4>YouTube</h4>
                  <span className="result-count">
                    {searchResults.youtube.length} matches
                  </span>
                </div>
                <div className="results-list">
              ...
              <div className="platform-card">
                <div className="platform-header">
                  ...
                  <h4>TikTok</h4>
                  <span className="result-count">
                    {searchResults.tiktok.length} matches
                  </span>
                </div>
                <div className="results-list">
